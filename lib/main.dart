...
class _TextProcessorPageState extends State<TextProcessorPage> {
  ...
  '[红包]', '[發]', '[福]', '[烟花]', '[爆竹]', '[猪头]', '[跳跳]', '[发抖]'
    ...
    EmojiPlatform.qq: ['😀', '😃', '😄', '😁', '😆', '😅', '🤣', '😂', '🙂', '🙃', '😉', '😊',
      ...
      '🤳', '💪'],
    EmojiPlatform.mo: [
  '[/哭笑]', '[/微笑]', '[/偷笑]', '[/得意]', '[/抠鼻]', '[/摊手]', '[/疑问]', '[/委屈巴巴]', '[/擦汗]', '[/尴尬]',
  '[/鼓掌]', '[/机智]', '[/恐惧]', '[/假哭]', '[/可怜]', '[/让我想想]', '[/崇拜]', '[/略略略]', '[/发怒]', '[/哒咩]',
  '[/鄙视]', '[/石化]', '[/闭嘴]', '[/摸头]', '[/抓狂]', '[/晕]', '[/再见]', '[/晚安]', '[/饿]', '[/加油]',
  '[/耶]', '[/坏笑]', '[/快哭了]', '[/难过]', '[/白眼]', '[/Emm]', '[/哼哼]', '[/好的]', '[/握手]', '[/拥抱]',
  '[/惊讶]', '[/撇嘴]', '[/头大]', '[/发呆]', '[/我好方]', '[/星星眼]', '[/脸红]', '[/捏脸]', '[/无奈]', '[/嘘]',
  '[/口罩]', '[/苦涩]', '[/嫌弃]', '[/气到炸裂]', '[/阴险]', '[/失望]', '[/敬礼]', '[/强撑]', '[/戳手]', '[/惊吓]',
  '[/流泪]', '[/皱眉]', '[/叹气]', '[/无语]', '[/社会]', '[/呆住]', '[/搓手]', '[/偷看]', '[/头秃]', '[/吐血]',
  '[/嘿哈]', '[/微醺]', '[/愉快]', '[/奸笑]', '[/真棒]', '[/生气]', '[/裂开]', '[/不屑]', '[/卒]', '[/不要想]',
  '[/热化了]', '[/暗中观察]', '[/飞吻]', '[/爱心]', '[/心碎]', '[/投降]', '[/搬砖]', '[/打工人]', '[/摸鱼]', '[/打call]',
  '[/吐]', '[/太爱了]', '[/笑yue了]', '[/六六六]', '[/生病]', '[/YYDS]', '[/佛系]', '[/吃瓜]', '[/在吗]', '[/摸锦鲤]',
  '[/小丑]', '[/夺笋]', '[/红包]', '[/炸弹]', '[/庆祝]', '[/烟花]', '[/爆竹]', '[/太阳]', '[/玫瑰]', '[/凋谢]',
  '[/发]', '[/中]', '[/嘴唇]', '[/菜刀]', '[/大便]', '[/咖啡]', '[/蛋糕]', '[/月亮]', '[/猪头]', '[/DOG]',
  '[/辣鸡]', '[/干杯]', '[/礼物]', '[/点赞]', '[/弱]', '[/勾引]', '[/肌肉]', '[/拳头]', '[/抱拳]', '[/合十]',
  '[/OK]', '[/摆手]', '[/胜利]', '[/福]'
],
  ...
  int _countZeroWidth(String text) {
    // 匹配范围：200B-200F, 2060-2065, FEFF, 00AD, E0001
    // 注意：包含 \u{E0001} 需要开启 unicode: true
    final reg = RegExp('[\\u200b-\\u200f\\u2060-\\u2065\\uFEFF\\u00AD\\u{E0001}]', unicode: true);
